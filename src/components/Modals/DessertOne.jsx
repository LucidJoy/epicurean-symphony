    ...
    <div className='app__specialMenu-modal glass'>
      <div className='app__specialMenu-modal_main'>
        <MdOutlineRestaurantMenu
          fontSize={27}
          onClick={() => setDessertOneModal(false)}
          className='overlay__close'
        />

        <div style={{ flex: 1 }}>
          <img src={images.cheese2} alt='risotto2' width='100%' height='100%' />
        </div>
        ...
        >
          <SubHeading
            title={restaurantData?.menu?.categories[2]?.items[0]?.name}
          />

          <p className='app__specialMenu-desc'>
            {restaurantData?.menu?.categories[2]?.items[0]?.description}
          </p>
          ...
          <p className='app__specialMenu-avail'>
            ...
            : creamy cheesecake, tangy passion fruit, and a mango coulis for an
            unforgettable dessert..
          </p>

          <p className='app__specialMenu-price p__cormorant'>
            ${restaurantData?.menu?.categories[2]?.items[0]?.price}
          </p>
        </div>
        ...
        <div style={{ flex: 1, padding: "15px" }}>
          ...
          <div style={{ color: "white" }}>
            {restaurantData?.menu?.categories[2]?.items[0]?.ingredients?.map(
              (ingredient) => (
          ...
          <div style={{ marginTop: "30px" }}>
            ...
            >
              <MenuItem
                title='Calories'
                data={
                  restaurantData?.menu?.categories[2]?.items[0]
